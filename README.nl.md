...
* **Competitie (Liga):** Voor het organiseren van een club- of regionale competitie met vaste teams. Het speelschema wordt vooraf gegenereerd en bepaalt wie wanneer tegen wie speelt. De rangschikking wordt berekend op basis van overwinningen, doelsaldo en onderling resultaat. Ondersteunt HTML-export van uitslagen en speelschema's.
* **Zwitsers Systeem (Formule Suisse):** Het eerlijkste systeem voor toernooien met veel deelnemers en beperkte tijd. Inclusief automatische berekening van overwinningen, doelsaldo en (fijne) Buchholz-punten voor een exacte rangschikking.
* **Iedereen tegen Iedereen (Round Robin):** Het klassieke competitiesysteem waarbij elk team in de loop van het toernooi tegen elk ander team speelt.
* **Knock-out Systeem (Directe eliminatie):** Voor klassieke finalerondes en zuivere knock-outtoernooien. Een overwinning betekent doorgaan, een nederlaag onmiddellijke uitschakeling. De koppelingen volgen het kruissysteem (1e vs. laatste, 2e vs. voorlaatste …), zodat topteams elkaar pas laat treffen. Bij een aantal deelnemers dat geen macht van twee is, wordt automatisch een tussenronde (cadrage) berekend.
...
* **Trip-Tête / Trio-systeem:** Teamformat voor drietallen waarbij elke ontmoeting bestaat uit Triplette, Doublette en Tête-à-tête. Na de gezamenlijke Triplette splitst het team zich tactisch op: twee spelers spelen de Doublette, één speler speelt de Tête-à-tête. Geschikt voor compacte teamtoernooien met veel afwisseling en een duidelijke ontmoetingsscore.
...
* Alle toernooisystemen ondersteund: Supermêlée, Zwitsers systeem, Iedereen tegen iedereen, K.-O., Maastrichts systeem, Formule X, Trip-Tête
...
De snelste manier is de **installer** van de [GitHub Releases](https://github.com/michaelmassee/Petanque-Turnier-Manager/releases) (Linux/Windows/macOS) – deze richt de extensie automatisch voor LibreOffice in.

Voor de volledige stap-voor-stap-handleiding (inclusief handmatige `.oxt`-installatie, Java-instellingen en OS-specifieke opmerkingen), zie de **[Installatie-wiki](https://github.com/michaelmassee/Petanque-Turnier-Manager/wiki/Installation)** (Duitstalig).
