...
/**
 * Bereinigte Teilnehmerliste für das Formule X Turniersystem – als Aushang und Webseite.
 * Listet alle aktiven Teams in einem mehrspaltigem Raster auf.
 */
public class FormuleXTeilnehmerSheet extends SheetRunner implements ISheet {
    ...
    public FormuleXTeilnehmerSheet(WorkingSpreadsheet workingSpreadsheet) {
        super(workingSpreadsheet, TurnierSystem.FORMULEX, "Formule X Teilnehmer");
