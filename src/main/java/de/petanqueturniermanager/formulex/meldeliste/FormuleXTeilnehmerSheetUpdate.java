...
/**
 * Aktualisiert die Formule-X-Teilnehmerliste ohne das Sheet neu zu erstellen.
 * <p>
 * Im Gegensatz zu {@link FormuleXTeilnehmerSheet#generate()} (vollständiger Neuaufbau mit
 ...
 */
public class FormuleXTeilnehmerSheetUpdate extends FormuleXTeilnehmerSheet {

    private static final Logger logger = LogManager.getLogger(FormuleXTeilnehmerSheetUpdate.class);
    ...
    public FormuleXTeilnehmerSheetUpdate(WorkingSpreadsheet workingSpreadsheet) {
