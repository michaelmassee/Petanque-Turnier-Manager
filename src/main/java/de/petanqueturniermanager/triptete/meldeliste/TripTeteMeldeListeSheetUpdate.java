...
/**
 * Aktualisiert die bestehende Trip-Tête-Meldeliste (Header, Sortierung, Formate).
 */
public class TripTeteMeldeListeSheetUpdate extends SheetRunner implements IMeldeliste<TeamMeldungen, Team> {
    ...
    public TripTeteMeldeListeSheetUpdate(WorkingSpreadsheet workingSpreadsheet) {
        super(workingSpreadsheet, TurnierSystem.TRIPTETE, "Trip-Tête-Meldeliste");
        delegate = new TripTeteMeldeListeDelegate(this, workingSpreadsheet);
    }
