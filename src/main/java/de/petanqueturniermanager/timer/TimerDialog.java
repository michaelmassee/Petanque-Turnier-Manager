 ...
 * <p>
 * Felder: Dauer (MM:SS), Bezeichnung (optional), Webserver-Port.
...
public class TimerDialog extends AbstractUnoDialog {
    ...
    private static final int DIALOG_HOEHE  = 130;
    ...
    protected void beiOkGeklickt() throws Exception {
        ...
        TimerEinstellungen.speichern(dauerText.trim(), port, bezeichnung);
        TimerManager.get().starten(dauerSekunden, bezeichnung, port);
        logger.info("Timer gestartet via Dialog: {} s, Port {}", dauerSekunden, port);
    }
