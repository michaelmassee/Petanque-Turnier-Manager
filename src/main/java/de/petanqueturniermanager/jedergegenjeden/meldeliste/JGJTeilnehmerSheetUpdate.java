...
/**
 * Aktualisiert die Jeder-gegen-Jeden-Teilnehmerliste ohne das Sheet neu zu erstellen.
 * <p>
 * Im Gegensatz zu {@link JGJTeilnehmerSheet#generate()} (vollständiger Neuaufbau mit
 ...
 */
public class JGJTeilnehmerSheetUpdate extends JGJTeilnehmerSheet {

    private static final Logger logger = LogManager.getLogger(JGJTeilnehmerSheetUpdate.class);
    ...
    public JGJTeilnehmerSheetUpdate(WorkingSpreadsheet workingSpreadsheet) {
