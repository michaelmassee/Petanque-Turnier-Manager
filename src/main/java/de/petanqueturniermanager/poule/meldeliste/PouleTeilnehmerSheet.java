...
public class PouleTeilnehmerSheet extends SheetRunner implements ISheet {
    ...
    public PouleTeilnehmerSheet(WorkingSpreadsheet workingSpreadsheet) {
        super(workingSpreadsheet, TurnierSystem.POULE, "Poule-Teilnehmer");
    ...
    public void generate() throws GenerateException {
        NewSheet.from(this, SheetNamen.pouleTeilnehmer(), SheetMetadataHelper.SCHLUESSEL_TEILNEHMER)
                .tabColor(getKonfigurationSheet().getTeilnehmerTabFarbe()).pos(DefaultSheetPos.POULE_WORK)
