...
/**
 * Aktualisiert die Poule-A/B-Checkin-Liste ohne das Sheet neu zu erstellen.
 * <p>
 * Im Gegensatz zu {@link PouleCheckinListeSheet#generate()} (vollständiger Neuaufbau mit
 ...
 */
public class PouleCheckinListeSheetUpdate extends PouleCheckinListeSheet {

	public PouleCheckinListeSheetUpdate(WorkingSpreadsheet workingSpreadsheet) {
