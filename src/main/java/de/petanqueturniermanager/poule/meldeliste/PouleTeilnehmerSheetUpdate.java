...
/**
 * Aktualisiert die Poule-A/B-Teilnehmerliste ohne das Sheet neu zu erstellen.
 * <p>
 * Im Gegensatz zu {@link PouleTeilnehmerSheet#generate()} (vollständiger Neuaufbau mit
 ...
 */
public class PouleTeilnehmerSheetUpdate extends PouleTeilnehmerSheet {

    private static final Logger logger = LogManager.getLogger(PouleTeilnehmerSheetUpdate.class);
    ...
    public PouleTeilnehmerSheetUpdate(WorkingSpreadsheet workingSpreadsheet) {
