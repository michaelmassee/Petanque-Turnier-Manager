...
public class PouleMeldeListeSheetUpdate extends SheetRunner implements ISheet, MeldeListeKonstanten {
    ...
    protected static final int MIN_ANZAHL_MELDUNGEN_ZEILEN = PouleListeDelegate.MIN_ANZAHL_MELDUNGEN_ZEILEN;

    public static final int AKTIV_WERT_NIMMT_TEIL = PouleListeDelegate.AKTIV_WERT_NIMMT_TEIL;
    public static final int AKTIV_WERT_AUSGESTIEGEN = PouleListeDelegate.AKTIV_WERT_AUSGESTIEGEN;
    ...
    public PouleMeldeListeSheetUpdate(WorkingSpreadsheet workingSpreadsheet) {
