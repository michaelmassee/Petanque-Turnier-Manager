...
/**
 * Aktualisiert die Kaskaden-KO-Teilnehmerliste ohne das Sheet neu zu erstellen.
 * <p>
 * Im Gegensatz zu {@link KaskadeTeilnehmerSheet#generate()} (vollständiger Neuaufbau mit
 ...
 */
public class KaskadeTeilnehmerSheetUpdate extends KaskadeTeilnehmerSheet {

    private static final Logger logger = LogManager.getLogger(KaskadeTeilnehmerSheetUpdate.class);
    ...
    public KaskadeTeilnehmerSheetUpdate(WorkingSpreadsheet workingSpreadsheet) {
