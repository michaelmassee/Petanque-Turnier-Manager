...
/**
 * Checkin-Liste des K.-O.-Systems: kompakte Druckansicht zum Abhaken der Teilnehmer.
 */
public class KoCheckinListeSheet extends AbstractTeilnehmerNamenCheckinListeSheet {
	...
	public KoCheckinListeSheet(WorkingSpreadsheet workingSpreadsheet) {
		super(workingSpreadsheet, TurnierSystem.KO, "Checkin Liste");
	...
	protected String getMetadatenSchluessel() {
		return SheetMetadataHelper.SCHLUESSEL_KO_CHECKIN_LISTE;
	}
	...
	public XSpreadsheet getXSpreadSheet() throws GenerateException {
		return SheetMetadataHelper.findeSheetUndHeile(
				...
				SheetMetadataHelper.SCHLUESSEL_KO_CHECKIN_LISTE,
				getCheckinSheetName());
	}
