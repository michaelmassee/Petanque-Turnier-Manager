...
/**
 * Aktualisiert die K.-O.-Teilnehmerliste ohne das Sheet neu zu erstellen.
 * <p>
 * Im Gegensatz zu {@link KoTeilnehmerSheet#generate()} (vollständiger Neuaufbau mit
 ...
 */
public class KoTeilnehmerSheetUpdate extends KoTeilnehmerSheet {

    private static final Logger logger = LogManager.getLogger(KoTeilnehmerSheetUpdate.class);
    ...
    public KoTeilnehmerSheetUpdate(WorkingSpreadsheet workingSpreadsheet) {
