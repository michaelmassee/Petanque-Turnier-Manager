...
/**
 * Aktualisiert die K.-O.-Checkin-Liste ohne das Sheet neu zu erstellen.
 * <p>
 * Im Gegensatz zu {@link KoCheckinListeSheet#generate()} (vollständiger Neuaufbau mit
 ...
 */
public class KoCheckinListeSheetUpdate extends KoCheckinListeSheet {

	public KoCheckinListeSheetUpdate(WorkingSpreadsheet workingSpreadsheet) {
