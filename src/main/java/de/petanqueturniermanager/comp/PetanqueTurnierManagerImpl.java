...
import de.petanqueturniermanager.konfigdialog.dialog.mainkonfig.TestKonfigDialog;
            ...
            if (!didHandle) {
                switch (action) {
                    ...
                    case "turnierkonfiguration":
                        ...
                        TestKonfigDialog testKonfigDialog = new TestKonfigDialog(currentSpreadsheet);
                        testKonfigDialog.createDialog();
