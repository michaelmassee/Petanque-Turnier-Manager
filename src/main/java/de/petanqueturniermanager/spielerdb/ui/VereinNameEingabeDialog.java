...
/**
 * Schmaler Eingabe-Dialog für einen einzelnen Vereinsnamen.
 * Wird sowohl beim Anlegen als auch beim Umbenennen verwendet.
 */
final class VereinNameEingabeDialog extends AbstractUnoDialog {
    ...
    VereinNameEingabeDialog(XComponentContext xContext, @Nullable String vorbelegt) {
        super(xContext);
    ...
    @Override protected String getTitel() {
        return I18n.get(vorbelegt == null
                ? "spielerdb.verein.titel.neu" : "spielerdb.verein.titel.bearbeiten");
    }
    ...
    protected void erstelleFelder(XMultiComponentFactory mcf, XMultiServiceFactory xMSF,
        ...
        controls.fixedText("lblName", I18n.get("spielerdb.verein.name"), 8, 10, 60, 10);
