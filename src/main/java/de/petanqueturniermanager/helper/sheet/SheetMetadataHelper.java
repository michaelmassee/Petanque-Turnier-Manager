...
public class SheetMetadataHelper {
	...
	public static final String SCHLUESSEL_SCHWEIZER          = "__PTM_SCHWEIZER_RANGLISTE__";
	public static final String SCHLUESSEL_MAASTRICHTER       = "__PTM_MAASTRICHTER_VORRUNDEN__";
