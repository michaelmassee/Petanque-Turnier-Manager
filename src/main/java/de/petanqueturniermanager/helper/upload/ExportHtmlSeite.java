...
public class ExportHtmlSeite {
    ...
    private String assembliere(List<String> tabellenHtml) {
        ...
        sb.append("</a>\n");
        sb.append("<a class=\"ptm-footer-logo-link\" href=\"").append(StringEscapeUtils.escapeHtml4(PTM_URL))
                .append("\" target=\"_blank\">");
        sb.append("<img class=\"ptm-footer-logo\" src=\"").append(PTM_EXPORT_LOGO_DATA_URI)
