...
/**
 * Aktualisiert die Schweizer-Teilnehmerliste ohne das Sheet neu zu erstellen.
 * <p>
 * Im Gegensatz zu {@link SchweizerTeilnehmerSheet#generate()} (vollständiger Neuaufbau mit
 ...
 */
public class SchweizerTeilnehmerSheetUpdate extends SchweizerTeilnehmerSheet {

    private static final Logger logger = LogManager.getLogger(SchweizerTeilnehmerSheetUpdate.class);
    ...
    public SchweizerTeilnehmerSheetUpdate(WorkingSpreadsheet workingSpreadsheet) {
