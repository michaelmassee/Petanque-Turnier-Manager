...
public class MaastrichterKonfigurationSheet extends SchweizerKonfigurationSheet implements IKoBracketKonfiguration {
	...
	public int getMinLetzteGruppeGroesse() {
		return getPropertiesSpalte().getMinLetzteGruppeGroesse();
	}

	public void setMinLetzteGruppeGroesse(int wert) {
		getPropertiesSpalte().setMinLetzteGruppeGroesse(wert);
	}
	...
	public int getCadrageTabFarbe()               { return getPropertiesSpalte().getCadrageTabFarbe(); }
