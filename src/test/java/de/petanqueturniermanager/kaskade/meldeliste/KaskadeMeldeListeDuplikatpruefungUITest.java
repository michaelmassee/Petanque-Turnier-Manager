 ...
 * Spaltenanzahl.
 */
class KaskadeMeldeListeDuplikatpruefungUITest extends BaseCalcUITest {
    ...
    void unterschiedlicherZweiterSpielerWirdNichtFaelschlichAlsDubletteErkannt() throws Exception {
        ...
        team1.newEmpty();
        team1.newInt(KaskadeListeDelegate.AKTIV_WERT_NIMMT_TEIL);
        ...
        team2.newEmpty();
        team2.newInt(KaskadeListeDelegate.AKTIV_WERT_NIMMT_TEIL);
        ...
        assertThatCode(() -> new KaskadeMeldeListeSheetUpdate(wkingSpreadsheet).doRun())
    ...
    void echteDubletteWirdWeiterhinErkannt() throws Exception {
        ...
        assertThatThrownBy(() -> new KaskadeMeldeListeSheetUpdate(wkingSpreadsheet).doRun())
