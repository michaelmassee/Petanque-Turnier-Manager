...
/**
 * Regressionstest für Formation.NUR_TEAMNAME: die Kaskaden-KO-Meldeliste hat keine
 ...
 * zugreift (siehe {@code KaskadeListeDelegate.getZeilenKennungSpalte()}).
 */
class KaskadeMeldeListeNurTeamnameUITest extends BaseCalcUITest {
    ...
    void meldelisteOhneSpielerspaltenWirdKorrektAufgebaut() throws Exception {
        ...
        meldeListeNew.createMeldelisteWithParams(Formation.NUR_TEAMNAME, false, false, 2);
