...
public class Props {
	...
	// problem: image does not appear next to text on toolbar
	{
		...
		props[4].Name = "Style";
		props[4].Value = ItemStyle.DRAW_FLAT + ItemStyle.ALIGN_LEFT + ItemStyle.AUTO_SIZE + ItemStyle.ICON
				+ ItemStyle.TEXT;
	...
	public static PropertyValue[] makeProps(String oName1, Object oValue1, String oName2, Object oValue2) {
	...
	public static PropertyValue[] makeProps(String oName1, Object oValue1, String oName2, Object oValue2, String oName3,
			Object oValue3) {
	...
	public static void setProperties(XPropertySet propSet, String[] nms, Object[] vals) {
		...
		for (int i = 0; i < nms.length; i++) {
			try {
				...
				System.out.println("Could not set read-only property \"" + nms[i] + "\": " + e);
			} catch (Exception e) {
	...
	/*
	 * Try to convert object to an indexed container, with each element containing a properties array. Show all the data.
	 */
	{
	...
	/*
	 * print out the properties as name = value pairs, one per line. If the value is a string array or a PropertyValue array, then cycle through the values in the array.
	 */
	{
