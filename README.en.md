...
[![Donate with PayPal](https://img.shields.io/badge/Donate-PayPal-blue.svg)](https://www.paypal.me/michaelmassee1)
...
The fastest way is the **installer** from the [GitHub Releases](https://github.com/michaelmassee/Petanque-Turnier-Manager/releases) (Linux/Windows/macOS) – it sets up the extension for LibreOffice automatically.

For the full step-by-step guide (including manual `.oxt` installation, Java setup, and OS-specific notes), see the **[Installation Wiki](https://github.com/michaelmassee/Petanque-Turnier-Manager/wiki/Installation)** (German).
