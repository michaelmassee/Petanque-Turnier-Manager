...
[![Pétanque-Turnier-Manager – Video-Vorstellung](https://img.youtube.com/vi/LqUxUOsfXQQ/maxresdefault.jpg)](https://www.youtube.com/watch?v=LqUxUOsfXQQ)
...
* **Trip-Tête / Trio-System:**
  Teamformat für Dreiermannschaften, bei dem jede Begegnung aus Triplette, Doublette und Tête-à-tête besteht. Nach dem gemeinsamen Triplette teilt sich das Team taktisch auf: zwei Spieler bestreiten das Doublette, ein Spieler das Tête-à-tête. Geeignet für kompakte Mannschaftsturniere mit viel Abwechslung und klarer Begegnungswertung.
...
* Alle Turniersysteme unterstützt: Supermêlée, Schweizer System, Jeder-gegen-Jeden, K.-O., Maastrichter System, Formule X, Trip-Tête
...
* **Betriebssystem:** Linux, Windows oder macOS 11 (Big Sur) oder neuer

---

## ⚙️ Installation & Einrichtung

Am schnellsten geht's mit dem **Installer** aus den [GitHub Releases](https://github.com/michaelmassee/Petanque-Turnier-Manager/releases) (Linux/Windows/macOS) – er richtet die Erweiterung für LibreOffice automatisch ein.

Die vollständige Schritt-für-Schritt-Anleitung (inkl. manueller `.oxt`-Installation, Java-Einrichtung und OS-spezifischen Hinweisen) findest du im **[Installations-Wiki](https://github.com/michaelmassee/Petanque-Turnier-Manager/wiki/Installation)**.
